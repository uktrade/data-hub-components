...
describe('My companies dashboard', () => {
  ...
  //   const wrapper = mount(
  //     <useMyCompaniesContext.Provider mockInitialState={{
  ...
  //         subject: 'Here is a long interaction title some more text some more'
  //           + ' text some more text almost finished some more text nearly'
  //           + ' there more text finished',
  //       },
  //     },
  //   ]
  //   const wrapper = mount(
  ...
  //     expect(wrapper.find('p').text())
  //       .toContain('No companies match your search')
  //   })
  // })
})
